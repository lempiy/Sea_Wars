...
export class ComplexEffect //for inheritance only
{
    ...
    constructor(staticSpriteName:string, effectSpriteNames:string, numberOfFrames:number, framesCounterBegining?:number) {
        this.staticSpriteURL = staticSpriteName
        this.staticSprite = PIXI.Sprite.fromFrame(this.staticSpriteURL)
        this.effect = new Effect(effectSpriteNames, numberOfFrames, framesCounterBegining)
